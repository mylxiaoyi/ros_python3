...
plugins/CMakeFiles/CameraPlugin.dir/CameraPlugin.cc.o: ../plugins/CameraPlugin.cc
	...
	cd /home/mylxiaoyi/ros_catkin_ws/src/gazebo-4.0.0/build/plugins && /usr/bin/c++   $(CXX_DEFINES) $(CXX_FLAGS) -o CMakeFiles/CameraPlugin.dir/CameraPlugin.cc.o -c /home/mylxiaoyi/ros_catkin_ws/src/gazebo-4.0.0/plugins/CameraPlugin.cc
...
plugins/CMakeFiles/CameraPlugin.dir/CameraPlugin.cc.i: cmake_force
	...
	cd /home/mylxiaoyi/ros_catkin_ws/src/gazebo-4.0.0/build/plugins && /usr/bin/c++  $(CXX_DEFINES) $(CXX_FLAGS) -E /home/mylxiaoyi/ros_catkin_ws/src/gazebo-4.0.0/plugins/CameraPlugin.cc > CMakeFiles/CameraPlugin.dir/CameraPlugin.cc.i
...
plugins/CMakeFiles/CameraPlugin.dir/CameraPlugin.cc.s: cmake_force
	...
	cd /home/mylxiaoyi/ros_catkin_ws/src/gazebo-4.0.0/build/plugins && /usr/bin/c++  $(CXX_DEFINES) $(CXX_FLAGS) -S /home/mylxiaoyi/ros_catkin_ws/src/gazebo-4.0.0/plugins/CameraPlugin.cc -o CMakeFiles/CameraPlugin.dir/CameraPlugin.cc.s
...
plugins/libCameraPlugin.so: gazebo/libgazebo.so.4.0.0
plugins/libCameraPlugin.so: gazebo/sensors/libgazebo_sensors.so.4.0.0
plugins/libCameraPlugin.so: gazebo/physics/libgazebo_physics.so.4.0.0
plugins/libCameraPlugin.so: gazebo/util/libgazebo_util.so.4.0.0
plugins/libCameraPlugin.so: gazebo/physics/ode/libgazebo_physics_ode.so.4.0.0
plugins/libCameraPlugin.so: deps/opende/libgazebo_ode.so.4.0.0
plugins/libCameraPlugin.so: deps/opende/GIMPACT/libgazebo_gimpact.so.4.0.0
plugins/libCameraPlugin.so: deps/opende/ou/libgazebo_opende_ou.so.4.0.0
plugins/libCameraPlugin.so: deps/libccd/libgazebo_ccd.so.4.0.0
plugins/libCameraPlugin.so: deps/opende/OPCODE/libgazebo_opcode.so.4.0.0
plugins/libCameraPlugin.so: gazebo/rendering/libgazebo_rendering.so.4.0.0
plugins/libCameraPlugin.so: gazebo/transport/libgazebo_transport.so.4.0.0
plugins/libCameraPlugin.so: gazebo/rendering/skyx/libgazebo_skyx.so.4.0.0
plugins/libCameraPlugin.so: gazebo/rendering/selection_buffer/libgazebo_selection_buffer.so.4.0.0
plugins/libCameraPlugin.so: gazebo/rendering/deferred_shading/libgazebo_rendering_deferred.so.4.0.0
plugins/libCameraPlugin.so: /usr/lib64/libGLU.so
plugins/libCameraPlugin.so: /usr/lib64/libGL.so
plugins/libCameraPlugin.so: /usr/lib64/libSM.so
plugins/libCameraPlugin.so: /usr/lib64/libICE.so
plugins/libCameraPlugin.so: /usr/lib64/libX11.so
plugins/libCameraPlugin.so: /usr/lib64/libXext.so
plugins/libCameraPlugin.so: gazebo/msgs/libgazebo_msgs.so.4.0.0
plugins/libCameraPlugin.so: gazebo/common/libgazebo_common.so.4.0.0
plugins/libCameraPlugin.so: /usr/lib64/libdl.so
plugins/libCameraPlugin.so: /usr/lib64/libfreeimage.so
plugins/libCameraPlugin.so: /usr/lib64/libtinyxml.so
...
plugins/libCameraPlugin.so: /usr/lib64/libboost_signals-mt.so
plugins/libCameraPlugin.so: /usr/lib64/libboost_system-mt.so
plugins/libCameraPlugin.so: /usr/lib64/libboost_filesystem-mt.so
plugins/libCameraPlugin.so: /usr/lib64/libboost_program_options-mt.so
plugins/libCameraPlugin.so: /usr/lib64/libboost_regex-mt.so
plugins/libCameraPlugin.so: /usr/lib64/libboost_iostreams-mt.so
plugins/libCameraPlugin.so: /usr/lib64/libboost_date_time-mt.so
plugins/libCameraPlugin.so: plugins/CMakeFiles/CameraPlugin.dir/link.txt
	...
	cd /home/mylxiaoyi/ros_catkin_ws/src/gazebo-4.0.0/build/plugins && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/CameraPlugin.dir/link.txt --verbose=$(VERBOSE)
