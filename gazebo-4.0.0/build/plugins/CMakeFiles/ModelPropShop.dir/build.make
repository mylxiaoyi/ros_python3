...
plugins/CMakeFiles/ModelPropShop.dir/ModelPropShop.cc.o: ../plugins/ModelPropShop.cc
	...
	cd /home/mylxiaoyi/ros_catkin_ws/src/gazebo-4.0.0/build/plugins && /usr/bin/c++   $(CXX_DEFINES) $(CXX_FLAGS) -o CMakeFiles/ModelPropShop.dir/ModelPropShop.cc.o -c /home/mylxiaoyi/ros_catkin_ws/src/gazebo-4.0.0/plugins/ModelPropShop.cc
...
plugins/CMakeFiles/ModelPropShop.dir/ModelPropShop.cc.i: cmake_force
	...
	cd /home/mylxiaoyi/ros_catkin_ws/src/gazebo-4.0.0/build/plugins && /usr/bin/c++  $(CXX_DEFINES) $(CXX_FLAGS) -E /home/mylxiaoyi/ros_catkin_ws/src/gazebo-4.0.0/plugins/ModelPropShop.cc > CMakeFiles/ModelPropShop.dir/ModelPropShop.cc.i
...
plugins/CMakeFiles/ModelPropShop.dir/ModelPropShop.cc.s: cmake_force
	...
	cd /home/mylxiaoyi/ros_catkin_ws/src/gazebo-4.0.0/build/plugins && /usr/bin/c++  $(CXX_DEFINES) $(CXX_FLAGS) -S /home/mylxiaoyi/ros_catkin_ws/src/gazebo-4.0.0/plugins/ModelPropShop.cc -o CMakeFiles/ModelPropShop.dir/ModelPropShop.cc.s
...
plugins/libModelPropShop.so: gazebo/libgazebo.so.4.0.0
plugins/libModelPropShop.so: gazebo/sensors/libgazebo_sensors.so.4.0.0
plugins/libModelPropShop.so: gazebo/physics/libgazebo_physics.so.4.0.0
plugins/libModelPropShop.so: gazebo/util/libgazebo_util.so.4.0.0
plugins/libModelPropShop.so: gazebo/physics/ode/libgazebo_physics_ode.so.4.0.0
plugins/libModelPropShop.so: deps/opende/libgazebo_ode.so.4.0.0
plugins/libModelPropShop.so: deps/opende/GIMPACT/libgazebo_gimpact.so.4.0.0
plugins/libModelPropShop.so: deps/opende/ou/libgazebo_opende_ou.so.4.0.0
plugins/libModelPropShop.so: deps/libccd/libgazebo_ccd.so.4.0.0
plugins/libModelPropShop.so: deps/opende/OPCODE/libgazebo_opcode.so.4.0.0
plugins/libModelPropShop.so: gazebo/rendering/libgazebo_rendering.so.4.0.0
plugins/libModelPropShop.so: gazebo/transport/libgazebo_transport.so.4.0.0
plugins/libModelPropShop.so: gazebo/rendering/skyx/libgazebo_skyx.so.4.0.0
plugins/libModelPropShop.so: gazebo/rendering/selection_buffer/libgazebo_selection_buffer.so.4.0.0
plugins/libModelPropShop.so: gazebo/rendering/deferred_shading/libgazebo_rendering_deferred.so.4.0.0
plugins/libModelPropShop.so: /usr/lib64/libGLU.so
plugins/libModelPropShop.so: /usr/lib64/libGL.so
plugins/libModelPropShop.so: /usr/lib64/libSM.so
plugins/libModelPropShop.so: /usr/lib64/libICE.so
plugins/libModelPropShop.so: /usr/lib64/libX11.so
plugins/libModelPropShop.so: /usr/lib64/libXext.so
plugins/libModelPropShop.so: gazebo/msgs/libgazebo_msgs.so.4.0.0
plugins/libModelPropShop.so: gazebo/common/libgazebo_common.so.4.0.0
plugins/libModelPropShop.so: /usr/lib64/libdl.so
plugins/libModelPropShop.so: /usr/lib64/libfreeimage.so
plugins/libModelPropShop.so: /usr/lib64/libtinyxml.so
...
plugins/libModelPropShop.so: /usr/lib64/libboost_signals-mt.so
plugins/libModelPropShop.so: /usr/lib64/libboost_system-mt.so
plugins/libModelPropShop.so: /usr/lib64/libboost_filesystem-mt.so
plugins/libModelPropShop.so: /usr/lib64/libboost_program_options-mt.so
plugins/libModelPropShop.so: /usr/lib64/libboost_regex-mt.so
plugins/libModelPropShop.so: /usr/lib64/libboost_iostreams-mt.so
plugins/libModelPropShop.so: /usr/lib64/libboost_date_time-mt.so
plugins/libModelPropShop.so: plugins/CMakeFiles/ModelPropShop.dir/link.txt
	...
	cd /home/mylxiaoyi/ros_catkin_ws/src/gazebo-4.0.0/build/plugins && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/ModelPropShop.dir/link.txt --verbose=$(VERBOSE)
