...
void Geometry::InitAsDefaultInstance() {
  ...
  polyline_ = const_cast< ::gazebo::msgs::Polyline*>(&::gazebo::msgs::Polyline::default_instance());
}
...
void Geometry::MergeFrom(const Geometry& from) {
  ...
  if (from._has_bits_[9 / 32] & (0xffu << (9 % 32))) {
    if (from.has_polyline()) {
      mutable_polyline()->::gazebo::msgs::Polyline::MergeFrom(from.polyline());
    }
  }
...
bool Geometry::IsInitialized() const {
  ...
  if (has_polyline()) {
    if (!this->polyline().IsInitialized()) return false;
  }
  return true;
}
...
void Geometry::Swap(Geometry* other) {
  if (other != this) {
    ...
    std::swap(polyline_, other->polyline_);
