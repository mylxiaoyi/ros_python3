...
class Geometry : public ::google::protobuf::Message {
 public:
  ...
  // optional .gazebo.msgs.Polyline polyline = 10;
  inline bool has_polyline() const;
  inline void clear_polyline();
  static const int kPolylineFieldNumber = 10;
  inline const ::gazebo::msgs::Polyline& polyline() const;
  inline ::gazebo::msgs::Polyline* mutable_polyline();
  inline ::gazebo::msgs::Polyline* release_polyline();
  inline void set_allocated_polyline(::gazebo::msgs::Polyline* polyline);
 ...
 private:
  ...
  ::gazebo::msgs::Polyline* polyline_;
  int type_;
...
// optional .gazebo.msgs.Polyline polyline = 10;
inline bool Geometry::has_polyline() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void Geometry::set_has_polyline() {
  _has_bits_[0] |= 0x00000200u;
}
inline void Geometry::clear_has_polyline() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void Geometry::clear_polyline() {
  if (polyline_ != NULL) polyline_->::gazebo::msgs::Polyline::Clear();
  clear_has_polyline();
}
inline const ::gazebo::msgs::Polyline& Geometry::polyline() const {
  return polyline_ != NULL ? *polyline_ : *default_instance_->polyline_;
}
inline ::gazebo::msgs::Polyline* Geometry::mutable_polyline() {
  set_has_polyline();
  if (polyline_ == NULL) polyline_ = new ::gazebo::msgs::Polyline;
  return polyline_;
}
inline ::gazebo::msgs::Polyline* Geometry::release_polyline() {
  clear_has_polyline();
  ::gazebo::msgs::Polyline* temp = polyline_;
  polyline_ = NULL;
  return temp;
}
inline void Geometry::set_allocated_polyline(::gazebo::msgs::Polyline* polyline) {
  delete polyline_;
  polyline_ = polyline;
  if (polyline) {
    set_has_polyline();
