...
void protobuf_AddDesc_joint_5fwrench_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "ench\030\006 \002(\0132\023.gazebo.msgs.Wrench", 231);
...
void JointWrench::InitAsDefaultInstance() {
  body_1_wrench_ = const_cast< ::gazebo::msgs::Wrench*>(&::gazebo::msgs::Wrench::default_instance());
  body_2_wrench_ = const_cast< ::gazebo::msgs::Wrench*>(&::gazebo::msgs::Wrench::default_instance());
}
...
void JointWrench::SerializeWithCachedSizes(
  ...
  if (has_body_1_wrench()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      5, this->body_1_wrench(), output);
  }

  // required .gazebo.msgs.Wrench body_2_wrench = 6;
  if (has_body_2_wrench()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      6, this->body_2_wrench(), output);
  }
...
bool JointWrench::IsInitialized() const {
  ...
  if (has_body_1_wrench()) {
    if (!this->body_1_wrench().IsInitialized()) return false;
  }
  if (has_body_2_wrench()) {
    if (!this->body_2_wrench().IsInitialized()) return false;
  }
  return true;
}
