...
static const uint qt_meta_data_QtTreePropertyBrowser[] = {
 ...
 // enum data: key, value
     387, uint(QtTreePropertyBrowser::Interactive),
     399, uint(QtTreePropertyBrowser::Stretch),
     407, uint(QtTreePropertyBrowser::Fixed),
     413, uint(QtTreePropertyBrowser::ResizeToContents),
